...
my $command = "$usearch_command --$dereplication_type --cluster $reduce_this_file.sorted --slots 4000003 --uc $reduce_this_file.uclust_log --seedsout $reduce_this_file.sorted.nr --maxlen 1000000";
