...
# use 'multiple_sequence_splitter.pl' to parse reference fasta database and split into many files, one for each gene
perl multiple_sequence_splitter.pl mam16S.fas
